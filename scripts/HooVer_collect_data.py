...
plasmalab_root = '/home/sundw/code/plasmalab-1.4.4/'

if __name__ == '__main__':
    # budgets = np.logspace(np.log(8e4)/np.log(2), np.log(8e5)/np.log(2), num=10, base=2).astype('int')
    budgets = np.logspace(np.log(3e4)/np.log(2), np.log(5e4)/np.log(2), num=10, base=2).astype('int')
    # budgets = budgets[::-1]
    budgets = budgets[-1::]
    outputs = []
